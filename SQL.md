...
WHERE <constraints expression> -- Global filter, first execution precedence
GROUP BY <column> -- Execute after WHERE
HAVING <constraints expression> -- Group filter, execute after GROUP

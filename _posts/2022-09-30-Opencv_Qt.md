...
# I don't know why OpenCV nests opencv2 into the opencv4 directory by default and they use #include <opencv2/...> in every header file. That makes it  unnaturally with gcc/g++ when compiling. So lets solve the promblem by eliminate the nesting.
